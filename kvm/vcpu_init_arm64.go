...
//
// Values cross-checked against github.com/linuxboot/voodoo (MIT
// licensed Go code; see trace/kvm/ioctl_arm64.go), which uses the same
// KVM_ARM_VCPU_INIT (0xae) and KVM_ARM_PREFERRED_TARGET (0xaf) ioctl
// numbers.
const (
